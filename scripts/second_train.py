...
model = load_model('C:\\Users\\NitghtWay\\PycharmProjects\\fit\\venv\\BCV001.h5')
...
history = model.fit(train_generator,batch_size=32,epochs=30,
        validation_data=validation_generator,callbacks=[early_stopping,lr_scheduler])
##########################################################################################################################################
model.save('C:\\Users\\NitghtWay\\PycharmProjects\\fit\\venv\\BCV002.h5')
##########################################################################################################################################
