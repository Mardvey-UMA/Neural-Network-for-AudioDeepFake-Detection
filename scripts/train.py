...
train_generator = train_datagen.flow_from_directory(train_dir, batch_size=32, class_mode='categorical',
                                                    target_size=(224, 224))
validation_generator = val_datagen.flow_from_directory(validation_dir, batch_size=32, class_mode='categorical',
                                                       target_size=(224, 224))
...
# base_model.save('C:\\Users\\NitghtWay\\PycharmProjects\\fit\\venv\\ResNet152.h5')
base_model = load_model('C:\\Users\\NitghtWay\\PycharmProjects\\fit\\venv\\ResNet152.h5')
...
##########################################################################################################################################
model.save('C:\\Users\\NitghtWay\\PycharmProjects\\fit\\venv\\BCV001.h5')
##########################################################################################################################################
